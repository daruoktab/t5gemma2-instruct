...
## Corpus Check
- 302 files · ~115,328,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3324 nodes · 3761 edges · 491 communities (427 shown, 64 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27980fb2`
...
3. `TRL RELEASES (1.0.0 to 1.7.0)` - 60 edges
4. `2. Inspeksi Data per 25 Record` - 42 edges
5. `_merge_and_overwrite_lora()` - 36 edges
6. `_UnslothGRPOTrainer` - 27 edges
7. `UNSLOTH RELEASES` - 27 edges
8. `Mengunduh artikel LLM post-training sebagai markdown` - 25 edges
9. `_UnslothRLOOTrainer` - 21 edges
10. `[MASTER] Analisis Vision T5Gemma2, Cangkok SigLIP & Strategi Training Vision` - 21 edges
...
## Communities (491 total, 64 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (41): CustomSeq2SeqTrainer_Evaluate_TEXTONLY, CustomSeq2SeqTrainer_Evaluate_VISION, GrokAdEMAMix, header(), log(), log_data(), log_fail(), log_info() (+33 more)
...
Cohesion: 0.05
Nodes (27): RLOOConfig, align_completion_tool_mask(), align_logprobs_with_mask(), calculate_pad_tokens_in_prompt(), _calculate_rewards(), compute_loss(), create_completion_attention_mask(), _get_per_token_logps_and_entropies() (+19 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (52): 1. Bagaimana TransformerLens Memisahkan Self vs Cross Attention?, 1. Struktur Arsitektur T5Gemma 2 di TransformerLens, 2. Apakah "Reverse-Engineering" Weight Tanpa Training Bisa Dilakukan?, 2. Metode "Cangkok Subspace Kesamaan" (Agar Model Tidak Hancur), 3. Matriks Perbandingan: Cangkok Mentah vs Task Vector Steering, 3. Mental Model & Solusi yang Benar: SFT (Supervised Fine-Tuning), Alur Pembentukan Hybrid Checkpoint (`T5Gemma-2-Instruct-Init`), 🔬 Analisis & Pembuktian Ilmiah Otomatis: (+44 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (52): CI, CI, CI, CI, CI, CI, CI, Deprecations (+44 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (39): add_image_context(), append_turn_pair(), ConversationResult, ConvState, create_model_instance(), detect_coherence_drift(), edit_turn_content(), get_conversation_status() (+31 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (24): KTOConfig, align_completion_tool_mask(), align_logprobs_with_mask(), calculate_pad_tokens_in_prompt(), create_completion_attention_mask(), HideLoggingMessage, left_pack_padding(), prepare_for_training_mode() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (45): 1. Statistik Global Dataset, 2. Inspeksi Data per 25 Record, Distribusi Penggunaan Token Tugas (<unused>):, [Indeks 0] ID: 300001 (Document-based), [Indeks 100] ID: 300101 (Document-based), [Indeks 125] ID: 300126 (Document-based), [Indeks 150] ID: 300151 (Document-based), [Indeks 175] ID: 300176 (Document-based) (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (44): 1. Konteks Permasalahan, 2.1 File Script Training (User), 2.2 File Source Transformers (Environment `unsloth`), 2. File yang Diperiksa, 3.1 `model_accepts_loss_kwargs` (Baris ~496-506), 3.2 `training_step()` - Baris ~1876-1940, 3.3 `_get_num_items_in_batch()` - Baris ~2123-2180, 3.4 `compute_loss()` - Baris ~1952-2030 (+36 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (21): DPOConfig, align_completion_tool_mask(), align_logprobs_with_mask(), calculate_pad_tokens_in_prompt(), create_completion_attention_mask(), HideLoggingMessage, left_pack_padding(), prepare_for_training_mode() (+13 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (20): SFTConfig, align_completion_tool_mask(), align_logprobs_with_mask(), calculate_pad_tokens_in_prompt(), create_completion_attention_mask(), HideLoggingMessage, left_pack_padding(), prepare_for_training_mode() (+12 more)
...
Cohesion: 0.07
Nodes (21): _BaseTrainer, RewardConfig, align_completion_tool_mask(), align_logprobs_with_mask(), calculate_pad_tokens_in_prompt(), create_completion_attention_mask(), HideLoggingMessage, left_pack_padding() (+13 more)
...
Cohesion: 0.05
Nodes (36): 1.1 Karakteristik Utama T5Gemma 2, 1.2 Formulasi Matematis Merged Attention, 1.3 Mengapa Direct Overwrite / Naive Grafting dari Gemma-IT Decoder Gagal?, 1. Landasan Arsitektur T5Gemma 2 & Merged Attention, 2.1 Konsep Task Vector Arithmetic, 2.2 Formulasi Matematika, 2.3 Pembuktian Empiris Kuantitatif (TransformerLens Dev Branch), 2. Metodologi 3-Way Task Vector Steering ($\Delta_{\text{instruct}}$) & Resep Kode (+28 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (16): EmptyLogits, 2026.7.2 2026.7.2 5.13.1 1.8.0 __UNSLOTH_VERSIONING__, This method allows to interpolate the pre-trained position encodings, to be able, Input shape: Batch x Time x Channel, Multi-headed attention from 'Attention Is All You Need' paper, Multihead Attention Pooling., SiglipAttention, SiglipAttention_forward() (+8 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (29): accept_pdf(), check_existing_docs(), cleanup_temp_files(), create_model_instance(), _download_pdf_helper(), get_progress(), _is_valid_pdf_url(), main() (+21 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (30): append_topics_log(), build_conversation_prompt(), build_topic_prompt(), call_deepseek_json(), call_deepseek_raw(), Config, _dump_model(), generate_conversation() (+22 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (30): Alam Semesta Logit dan Pemetaan Eksponensial, Alur Diagnostik dan Strategi Resolusi Kestabilan Numerik, Analisis Kaulan Akar Penyebab: Mengapa Logit Masking Membakar Loss, Analisis Komprehensif Mekanisme Logit Masking dan Patofisiologi Divergensi Loss pada Lingkungan Komputasi Marimo Molab, Analisis Visual Anomali Kurva Loss, Anatomi Operasional dan Kode Logit Masking, Aplikasi Lanjutan, Pemodelan Karakter, dan Variasi Cross-Entropy, Attention Masking: Mengendalikan Sirkuit Aliran Konteks Jendela Perhatian (+22 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (30): 1. 2-Stage vs. 1-Stage Joint Co-Training (Pertanyaan Utama Flow), 1. Evaluasi & Validasi Alur Pipeline (`working-molab-v6-combined-unsloth.py`), 2. Riset & Bedah Metodologi Unik dalam Kode, 2. Riset Optimizer: `GrokAdEMAMix` vs. Alternative, 3. Evaluasi Logit Masking & Selective Label Smoothing, 3. Integrasi Dokumen Riset (`docs/Reverse Engineering T5Gemma Merge Attention.md`), 4. Rekomendasi Langkah Integrasi ke `working-molab-v6-combined-unsloth.py`, 4. Ringkasan & Blueprint Arsitektur Ideal (Actionable Summary) (+22 more)

### Community 24 - "Community 24"
Cohesion: 0.14
Nodes (29): cosine_similarity(), encode_texts(), eval_crosslingual(), eval_duplicate_detection(), eval_faq_matching(), eval_intent_classification(), eval_paraphrase_detection(), eval_semantic_search() (+21 more)
...
Cohesion: 0.13
Nodes (21): _canonical_lora_weights_for_grouped_mm(), extract_moe_lora_weights_for_grouped_mm(), _get_lora_wrapper_for_param(), _get_moe_lora_io_dims(), _get_param_shape_from_module(), _GroupedMMRecompute, _is_gpt_oss_model(), _iter_model_configs() (+13 more)
...
Cohesion: 0.1
Nodes (20): CHANGELOG ANALYSIS, Version v1.0.0, Version v1.1.0, Version v1.2.0, Version v1.3.0, Version v1.4.0, Version v1.5.0, Version v1.5.1 (+12 more)

### Community 37 - "Community 37"
Cohesion: 0.1
Nodes (20): _collect_fp8_weight_keys(), _estimate_resized_shard_bytes(), find_skipped_quantized_modules(), fix_tokenizer_config_json(), _get_hf_cache_dir(), _inplace_rewrite_resized_shard(), is_hf_sharded_safetensors(), _merge_and_overwrite_lora() (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.1
Nodes (20): code:python (# HAPUS ini di Seq2SeqVisionCollator dan VisionORPOCollator:), code:python (def evaluate(self, eval_dataset=None, ignore_keys=None, metr), Fix #1 — Hapus BOS/EOS manual di Collator, Fix #3 — Tambah `for_inference/for_training` di CustomSeq2SeqTrainer, Fix yang Diperlukan, Planner Response, Planner Response, Planner Response (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (17): Assistant, code:python (if not _should_run:), code:python (def _do_steering():), code:python (def _skip_and_exit():), code:python (if _should_run:), code:python (if not _should_run:), code:python (if not _should_run:), code:python (if not _should_run:) (+9 more)

### Community 40 - "Community 40"
Cohesion: 0.11
Nodes (17): 1. Temuan Masalah Dataset, 2. Root Cause di Script Generate, 3. Impact ke Training, 4. Plan Perbaikan, 5. Script Batch Fix, 6. Workflow Eksekusi, 7. Validasi, 8. Post-Fix: Merge & Replace (+9 more)
...
Cohesion: 0.19
Nodes (13): ConversationGenBody, DialogueTurn, Satu objek JSON dari tahap generate topik., TopicGenResponse, Turn, BaseModel, generate_niches(), load_blacklist() (+5 more)
...
Cohesion: 0.15
Nodes (14): _apply_lora_grouped_mm(), forward_moe_backend(), forward_native_moe_loop(), forward_triton_grouped_gemm(), _get_routing_indices(), _has_lora_adapters(), Grouped-GEMM MoE forward via Triton kernels (torch.compile-compatible, mode="max, Loop over experts with routed tokens; torch.compile-disabled to avoid graph brea (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.24
Nodes (10): Conversation, encode_image_to_base64(), extract_json_block(), generate_chat_for_images(), main(), OpenAgenticClient, Memastikan role bergantian user, assistant, user, assistant dst., Mengonversi file gambar ke string base64. (+2 more)

### Community 58 - "Community 58"
Cohesion: 0.15
Nodes (13): 🔴 #1 — ROOT CAUSE UTAMA: Projector "Cangkok" Tidak Compatible, 🔴 #2 — `finetune_vision_layers=False`: Vision Tower Frozen, 🔴 #3 — Hyperparameter Tidak Konsisten, 🔴 #4 — Kenapa Text-Only Quality Juga Turun?, 🟡 #5 — RSLoRA Scaling Explosion, code:python (# line 1441), 🔍 Hasil Analisis: Mengapa Vision Training Jauh Lebih Buruk, Planner Response (+5 more)

### Community 59 - "Community 59"
Cohesion: 0.15
Nodes (13): Breaking changes, Bugfixes and improvements, DeepSeek-V4, EXAONE-4.5, Gemma 4 Assistant, Granite4Vision, GraniteSpeechPlus, New Model additions (+5 more)

### Community 60 - "Community 60"
Cohesion: 0.15
Nodes (13): Breaking changes, Bugfixes and improvements, Cache, DeepSeek-OCR-2, Gemma4 unified+ Gemma4 MTP, Mellum, New Model additions, Parallelization (+5 more)

### Community 61 - "Community 61"
Cohesion: 0.15
Nodes (13): Chunked cross-entropy loss for SFT (up to –50% VRAM), code:python, code:python, code:python, Even more training chat templates, Features, GRPO Liger kernel update (Liger 0.8.0), KTO ↔ DPO alignment: closing in on graduation (+5 more)

### Community 62 - "Community 62"
Cohesion: 0.15
Nodes (13): Built-in reward functions now log extra columns, Chunked LM head for memory-efficient log-prob computation in `AsyncGRPOTrainer`, code:python, code:python, code:python, code:python, code:python, `DistillationTrainer` for efficient on-policy distillation (+5 more)

### Community 63 - "Community 63"
Cohesion: 0.21
Nodes (11): apply_logit_mask(), generate_response(), load_model(), Inference Script untuk Fine-tuned T5Gemma-2-270m-270m ==========================, Generate response dari encoder-decoder model.      Encoder menerima instruksi/pe, Jalankan test examples dan tampilkan hasilnya., Interactive multi-turn mode.     Conversation history di-maintain dan di-concat, Menerapkan logit masking secara dinamis lewat PyTorch forward hook. (+3 more)

### Community 64 - "Community 64"
Cohesion: 0.29
Nodes (11): build_dpo_prompt(), call_api(), generate_dpo_pair(), get_existing_inputs(), load_jsonl(), main(), parse_json_loose(), prepare_candidates() (+3 more)

### Community 65 - "Community 65"
Cohesion: 0.23
Nodes (10): build_preference_prompt(), Config, _dump_model(), main(), PreferenceRecord, Generate dataset preferensi untuk tahap **DPO / ORPO** (setelah SFT), memakai De, Satu baris preferensi untuk JSONL., Instruksi untuk menghasilkan SATU objek JSON preferensi. (+2 more)

### Community 66 - "Community 66"
Cohesion: 0.23
Nodes (11): free_gpu(), generate(), _latest_checkpoint(), load_base_model(), load_finetuned_model(), Evaluasi Komparatif: Base Model vs Fine-tuned Model (Instruction Tuning) =======, Load base model tanpa adapter., Load base model + LoRA adapter dari checkpoint. (+3 more)

### Community 67 - "Community 67"
Cohesion: 0.17
Nodes (9): 1. Latar Belakang & Kebutuhan Kuantisasi, 2. Masalah yang Ditemukan (The AssertionError), 3. Analisis Penyebab Utama (Root Cause), 4. Solusi Konfigurasi, 5. Hasil Verifikasi & Uji Coba Lokal, 6. Penerapan pada Kode Project, code:python (local_model = AutoModelForSeq2SeqLM.from_pretrained(load_sou), code:tb (AssertionError: assert module.weight.shape[1] == 1) (+1 more)

### Community 68 - "Community 68"
Cohesion: 0.17
Nodes (12): 9. Verifikasi Nama Module (Empiris), code:block11 (self_attn.q_proj   (1024, 640)   ← 270m; 4B: (2048, 2560)), code:block12 (self_attn.q_proj    (1152, 1152)   ← ⚠️ NAMA SAMA dgn text!), code:block13 (T5Gemma2MultiModalProjector (0.738M params)), code:block14 (self_attn.q_proj   (1024, 640)   ← Merged Attention (self+cr), code:block15 (lm_head                T5Gemma2LMHead (container)), Decoder (34 layers) — `model.decoder.layers.{X}`, Encoder Text (34 layers) — `model.encoder.text_model.layers.{X}` (+4 more)

### Community 69 - "Community 69"
Cohesion: 0.17
Nodes (11): 10. "Bocor" LoRA ke Vision Tower, 11. Verifikasi 3-Arah Bobot Vision, Analisis, Bocor ≠ Rusak, code:python (LORA_TARGET_MODULES = ["q_proj", "k_proj", "v_proj", "o_proj), Daftar Isi, Hasil, [MASTER] Analisis Vision T5Gemma2, Cangkok SigLIP & Strategi Training Vision (+3 more)

### Community 70 - "Community 70"
Cohesion: 0.25
Nodes (7): api_load_model(), apply_logit_mask(), chat(), format_chat_prompt(), init_model(), load_model_and_tokenizer(), Menerapkan logit masking secara dinamis lewat PyTorch forward hook.

### Community 71 - "Community 71"
Cohesion: 0.29
Nodes (10): augment_row(), build_augmentation_prompt(), call_api(), extract_context_and_question(), main(), parse_json_loose(), process_file(), [Phase 1.2] Augment IndoQA — Buat Jawaban Lebih Panjang & Explanatory ========== (+2 more)

### Community 72 - "Community 72"
Cohesion: 0.29
Nodes (10): analyze_dataset(), clean_dataset(), count_words(), load_jsonl(), main(), print_report(), [Phase 1.3] Fix & Validasi Dataset — Bersihkan Empty Targets & Anomali =========, Bersihkan dataset: hapus empty target + exact duplicates. (+2 more)

### Community 73 - "Community 73"
Cohesion: 0.2
Nodes (7): apply_edits(), ConversationEditResult, create_model_instance(), CustomHTTPClient, EditState, Terapkan semua prefix token dan revisi konten asisten di dalam percakapan ini se, TurnEdit

### Community 74 - "Community 74"
Cohesion: 0.18
Nodes (10): 1. `generate_prefix_tasks.py`, 2. `generate_from_unused_topics.py`, 3. `generate_indoqa_v2.py`, 4. `augment_indoqa_targets.py`, 5. `generate_longform_dataset.py`, 6. `expand_dpo_dataset.py`, 7. `fix_dataset_quality.py`, Dokumentasi Pembuatan Dataset Berbasis Agen (Dataset Generation Pipeline) (+2 more)

### Community 75 - "Community 75"
Cohesion: 0.18
Nodes (10): 1. Statistik Dasar Dataset, 2. Analisis Panjang Teks (Jumlah Kata), 3. Analisis Kebocoran Data (Data Leakage), 4. Distribusi Kata Tanya (Intent Analysis), 5. Kesimpulan Kualitas Dataset & Temuan Kunci, Chat Dataset Leakage:, IndoQA Dataset Leakage:, Laporan Analisis Kualitas Dataset (SFT & Validation) (+2 more)

### Community 76 - "Community 76"
Cohesion: 0.18
Nodes (11): Attention, Bugfixes and improvements, DEIMv2, Generation, Kernels, Laguna, New Model additions, Release v5.6.2 (+3 more)

### Community 77 - "Community 77"
Cohesion: 0.18
Nodes (11): Audio, Breaking changes, Bugfixes and improvements, Cohere2Moe, Generation, HRM-Text, New Model additions, Parakeet tdt (#44171) (+3 more)

### Community 78 - "Community 78"
Cohesion: 0.18
Nodes (11): code:python, code:python, code:python, code:bash, Features, KTO ↔ DPO alignment: nearing the finish line, More `{% generation %}` training chat templates, New experimental TPO trainer (+3 more)
...
Cohesion: 0.22
Nodes (7): add_samples(), build_chains(), format_multiturn_input(), Build Dataset v2 untuk Fine-tuning T5Gemma-2 Instruct ==========================, Gabungkan history + current turn ke dalam satu string untuk encoder.     Format:, Rekursif bangun conversation chains dari tree OASST., Quality filter + tambah ke global list, print stats.

### Community 82 - "Community 82"
Cohesion: 0.2
Nodes (10): _base_is_recomputable(), _moe_recompute_default(), _moe_recompute_enabled(), True iff the base expert weight can be rebuilt in backward (frozen and     group, Pin-vs-recompute decision independent of the source weight.      Adaptive by def, True iff pinning this base means holding a large dense dequant of a compressed, Whether to recompute the dequantized base stack in backward (True) or pin it, Use separated LoRA (default True); UNSLOTH_MOE_LORA_MERGED=1 forces the merged p (+2 more)

### Community 83 - "Community 83"
Cohesion: 0.2
Nodes (10): ✅ BUG #1 — CLEARED: Double BOS di Collator (NOT A BUG), ✅ BUG #3 — KRITIS: Model Stuck Eval Mode (CONFIRMED), ✅ BUG #4 — KRITIS: BOS Mismatch Training vs Validation (CONFIRMED), ✅ BUG #5 — PENTING: Effective LR 8x Lebih Agresif (CONFIRMED), code:block14 (VISION:    model.training=True → evaluate() → model.training), code:block15 (Training path  (processor.__call__) : [2, 500, 501, 1]  ← BO), code:block16 (Vision:    2e-5 / 16 = 1.25e-6  (effective LR)), 📊 Hasil Diagnostic — 4 Bug Confirmed (+2 more)

### Community 84 - "Community 84"
Cohesion: 0.2
Nodes (10): Assistant, code:python (import ast as _ast), code:python (class _App:), code:block225 ("""), code:block226 ("""), code:python (body = "\n".join(l[4:] if l.startswith("    ") else l for l ), code:json ({), code:block229 (Edit applied successfully.) (+2 more)

### Community 85 - "Community 85"
Cohesion: 0.2
Nodes (9): 1. Model DeepSeek Wajib Menggunakan Protokol Anthropic, 2. Perilaku Khusus URL pada SDK Anthropic (Resolusi `/v1`), Aturan Konfigurasi Penting, code:json ({), code:python (if provider == "anthropic":), code:env (API_BASE_URL="https://api.openmodel.ai/v1"), Dokumentasi Integrasi OpenModel API, Masalah Umum: Error 404 (Route Not Found) (+1 more)
...
Cohesion: 0.22
Nodes (9): backward(), forward(), _grouped_mm_with_backward_fix(), _manual_grouped_mm(), native_moe_grouped_mm(), Grouped matmul; passes the weight as a transposed view (no copy) when safe., Differentiable grouped matmul fallback for torch._grouped_mm alignment gaps., Grouped_mm with backward fix for PyTorch's grouped_mm backward stride bug. (+1 more)

### Community 90 - "Community 90"
Cohesion: 0.22
Nodes (9): _check_grouped_gemm_available(), _check_torch_grouped_mm_supported(), _init_triton_allocator(), _log_info(), Check torch._grouped_mm support on the current GPU; a runtime probe is the only, Initialize a persistent Triton allocator to avoid per-call allocation overhead., Check if Unsloth grouped GEMM kernels are available., Select MoE backend from UNSLOTH_MOE_BACKEND + availability.      Choices: "group (+1 more)

### Community 91 - "Community 91"
Cohesion: 0.22
Nodes (9): _get_compile_location(), get_forward_moe_backend(), install_to_cache(), _load_cached_moe_utils_module(), patch_param_wrapper_for_moe(), _patch_peft_get_peft_model_for_moe(), Resolve forward_moe_backend from the compiled cache copy, else the local def., Patch PEFT's ParamWrapper.forward for MoE separated LoRA (call after PEFT import (+1 more)

### Community 92 - "Community 92"
Cohesion: 0.22
Nodes (8): Chat Conversation, Planner Response, Planner Response, Planner Response, Planner Response, Planner Response, === TEXT-ONLY REPO ===, User Input

### Community 93 - "Community 93"
Cohesion: 0.22
Nodes (9): Assistant, code:block79 (Phase 0.5 (optional): 3-Way Task Vector Steering), code:python (@app.cell), code:python (STEERING_ALPHA_FFN = 0.8       # gate/up/down — aman penuh), code:block82 (steered/        (Phase 0.5 output — full model + tokenizer)), code:json ({), code:block84 (<path>D:\Codings\unsloth-porto\t5-gemma-2\instruct\scripts\t), code:json ({) (+1 more)

### Community 94 - "Community 94"
Cohesion: 0.22
Nodes (9): 3. ROUGE-1, ROUGE-2, ROUGE-L (Recall-Oriented Understudy for Gisting Evaluation), 💡 Analogi, 📊 Cara Baca, 🎯 Di Laporan Anda, 🧠 Logika Pengukuran, 📌 Ngukur Apa?, ROUGE-1 (Unigram), ROUGE-2 (Bigram) (+1 more)

### Community 95 - "Community 95"
Cohesion: 0.22
Nodes (8): 1. Algoritma Pembuatan Dataset (*Data Generation*), 2. Algoritma Modifikasi Tokenizer (*Logit Masking*), 3. Algoritma Pelatihan (*Training Loop*), 4. Algoritma Inferensi (*Assistant-Driven Routing*), Algoritma & Pipeline Proyek: T5Gemma-2-Instruct (Assistant-Driven Prefix), code:mermaid (graph TD), 🌊 Diagram Alir Utama (Mermaid), 📝 Penjelasan Langkah Algoritma (Step-by-Step)

### Community 96 - "Community 96"
Cohesion: 0.22
Nodes (8): 1. Dinamika Loss dan Perplexity (PPL), 2. Kualitas Generasi Teks (NLG Metrics), Analisis Komprehensif, Kesimpulan & Rekomendasi, Laporan Analisis Lengkap Metrik SFT: `t5gemma-2-4b-4b-instruct-chat-indo-v4-unsloth`, Ringkasan Metadata Training, Tabel Log Metrik Lengkap, Visualisasi Dashboard Metrik SFT

### Community 97 - "Community 97"
Cohesion: 0.22
Nodes (9): 15. Chat Template: Original Tidak Punya, code:block21 (.gitattributes, README.md, config.json, generation_config.js), code:python (from unsloth.chat_templates import get_chat_template), code:jinja ({{ bos_token }}), Gemma 3 4B IT: Punya chat_template.json, Implikasi, Sumber Chat Template, Template Content (gemma-3) (+1 more)

### Community 98 - "Community 98"
Cohesion: 0.22
Nodes (9): 5. Logit Masking & Suppression, code:python (SUPPRESS_BLOCK1 = [6] + list(range(13, 105))   # unused0, un), code:python (SUPPRESS_BLOCK1 = [6] + list(range(13, 105))  # ID 7-12 di-s), code:json ("task_prefix_mapping": {), Kenapa Aman untuk Vision, Konsistensi dengan Text-Only v6, Mekanisme, SelectiveLabelSmoother (+1 more)

### Community 99 - "Community 99"
Cohesion: 0.22
Nodes (9): Bugfixes and improvements, DeepSeek-V3.2, DiffusionGemma, Kernels, New Model additions, Parallelization, Release v5.10.2, Release v5.11.0 (+1 more)

### Community 100 - "Community 100"
Cohesion: 0.29
Nodes (4): create_model_instance(), OrpoGenerationResult, OrpoState, RateLimitedAsyncClient

### Community 101 - "Community 101"
Cohesion: 0.25
Nodes (8): _base_grouped_mm(), forward_native_grouped_mm(), _get_base_weight(), _moe_gategrad_enabled(), Whether the MoE gate-gradient identity path is active (on by default).      Cach, Native PyTorch grouped-GEMM MoE forward via torch._grouped_mm (no Triton; needs, recompute -> rebuild W in backward; else the prior eager grouped_mm., Get base weight from a potentially wrapped parameter or module. target_dtype (re

### Community 102 - "Community 102"
Cohesion: 0.25
Nodes (8): _extract_lora_from_wrapper(), _extract_lora_weights(), _is_moe_experts_module(), _patched_param_wrapper_forward(), Generic check for an MoE experts layer with stacked 3D expert weights.      Matc, Patched ParamWrapper.forward for MoE separated LoRA.      For MoE experts: bypas, Extract LoRA weights from a PEFT ParamWrapper for MoE separated grouped_mm., Compat wrapper around _extract_lora_from_wrapper; returns (first, second, scalin
...
Cohesion: 0.33
Nodes (6): Assistant, code:python (_optimizer = create_optimizer(...) if OPTIMIZER_TYPE != "pag), code:python (files = list_repo_files(UNIFIED_HF_REPO) (create repo public), code:json ({), code:block103 (Edit applied successfully.), code:python (def build_optimizer(model, base_lr, weight_decay, mults, opt)
...
Cohesion: 0.33
Nodes (6): 14. Fix Tokenizer Config Repo Cangkok, code:python (# Download tokenizer_config.json dari v6 merged (lengkap)), Hasil Verifikasi, Masalah 1: task_prefix_mapping Hilang, Masalah 2: added_tokens_decoder Hilang, Script: `scripts/tests/patch_cangkok_tokenizer.py`

### Community 140 - "Community 140"
Cohesion: 0.33
Nodes (6): 2. Mekanisme Image Encoder (SigLIP), Cara Kerja Image Pipeline, code:block1 (Gambar (896×896)), Processor: Gemma3Processor, Spesifikasi SigLIP, Token Image
...
Cohesion: 0.4
Nodes (5): Assistant, code:python (force_branch = group.get("force_branch", None)), code:python (groups = []), code:json ({), code:block188 (Edit applied successfully.)
...
Cohesion: 0.4
Nodes (4): Bare Minimum Setup untuk T5/Sequence-to-Sequence (TRL), code:python (if getattr(model.config, "decoder_start_token_id", None) is ), code:python (# Contoh ORPO Config), Rekomendasi Konkret
...
Cohesion: 0.4
Nodes (5): 13. Decoder Transplant vs SigLIP Transplant, code:block19 (Gemma 3 IT decoder:  Standard Self-Attention), Kenapa Decoder Transplant Hancur, Kenapa SigLIP Transplant Aman, Projector — Perlu Hati-hati tapi Aman
...
Cohesion: 0.5
Nodes (4): _copy_file_from_source(), If ALL files exist in the HF cache, copy them into target_dir_str.     Returns T, Copies a file from src_path to target_dir_str/filename using os.path., _try_copy_all_from_cache()
...
Cohesion: 0.5
Nodes (4): Bug Fixes and more cross platform support, code:block5, code:block6, To update Unsloth or install a new Unsloth Studio, you must use:

### Community 210 - "Community 210"
Cohesion: 0.5
Nodes (4): code:block7, code:block8, Release v0.1.44-beta, To update Unsloth or install a new Unsloth Studio, you must use:
...
Cohesion: 0.67
Nodes (3): Assistant, code:json ({), code:block35 (Edit applied successfully.)
...
Cohesion: 0.67
Nodes (3): Apa yang Sebenarnya Dikatakan Paper-paper Ini, KTO — Insight Kritis yang Sering Dilewati, ORPO — Yang Benar-benar Reference-Free
...
Cohesion: 0.67
Nodes (3): Apa yang Sebenarnya Dikatakan Paper, DPO (Rafailov et al., 2023), SimPO (Meng et al., 2024)
...
Cohesion: 0.67
Nodes (3): 1. Mengapa "Cangkok" Weight Gemma-IT ke T5Gemma Decoder Gagal?, Formula Merged Attention di T5Gemma 2:, Penyebab Utama Kegagalan Grafting Weight:
